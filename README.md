...
The `<auro-loader>` custom element also supports three pre-defined color modes, `onLight`, `onDark`.
...
<script src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-loader@4.0.0/dist/auro-loader__bundled.js" type="module"></script>
```
